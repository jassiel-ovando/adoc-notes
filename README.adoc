...
xref:sem/doc.adoc[Reference to another asciidoc file that should be converted to html]
...
xref:posts/doc1.adoc[Referecne to another asciidoc file that should be converted to html]
